            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    if ($data['product']['discount_price'] > 0):
                        ...
                        <h6>Giá giảm: <strong class="text-danger">
                                <?= number_format($data['product']['price'] - $data['product']['discount_price']) ?> đ
                            </strong></h6>
                                    ...
                                    <div class="d-flex flex-row comment-row m-t-0">
                                        <div class="p-2">
                                            ...
                                            if ($item['avatar']):
                                                ...
                                                ?>
                                                <img src="<?= APP_URL ?>/public/uploads/users/default.png" alt="user" width="50"
                                                    class="rounded-circle">
                                        ...
                                        <div class="comment-text w-100">
                                            ...
                                            <div class="comment-footer">
                                                ...
                                                <button type="button" class="btn btn-cyan btn-sm" data-toggle="collapse"
                                                    data-target="#<?=$item['username']?><?=$item['id']?>" aria-expanded="false" aria-controls="comment">Sửa</button>
