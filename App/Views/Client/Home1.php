    ...
    <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
      ...
      <span class="visually-hidden">Next</span>
            ...
            <div class="col-md-3">
                <div class="card  rounded-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="box-price">
                        <div class="price"><del>10.000</del></div>
                        <div class="price-sale text-danger">9.000</div>
                      </div>
                        <div class="btn col-md-12">
                        <button type="button" class="btn btn-title text-center col-md-7">Xem khóa học</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-md-3 ">
                <div class="card rounded-4">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRknXnSCHS77kp2fBhPLnPb-iu8XLrVi6QaKQ&s" class="card-img-top rounded-top-4" alt="Bài viết 1">
                    <div class="card-body">
                        <h5 class="card-title">Tổng hợp các sản phẩm của học viên tại F8</h5>
