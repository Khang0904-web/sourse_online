...
//  *** Lesson
// GET /lesson (lấy danh sách sản phẩm)
Route::get('/admin/lessons', 'App\Controllers\Admin\LessonController@index');

// GET /lessons/create (hiển thị form thêm sản phẩm)
Route::get('/admin/lessons/create', 'App\Controllers\Admin\LessonController@create');

// POST /lessons (tạo mới một sản phẩm)
Route::post('/admin/lessons', 'App\Controllers\Admin\LessonController@store');

// GET /lessons/{id} (lấy chi tiết sản phẩm với id cụ thể)
Route::get('/admin/lessons/{id}', 'App\Controllers\Admin\LessonController@edit');

// PUT /lessons/{id} (update sản phẩm với id cụ thể)
Route::put('/admin/lessons/{id}', 'App\Controllers\Admin\LessonController@update');

// DELETE /lessons/{id} (delete sản phẩm với id cụ thể)
Route::delete('/admin/lessons/{id}', 'App\Controllers\Admin\LessonController@delete');
